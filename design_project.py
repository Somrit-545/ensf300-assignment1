...
def get_platform():
    ...
    if (user_input != "0" and user_input != "1" and user_input not in gi.PLATFORM):
        ...
        # Loops in platform list and prints with correct formating
        ...
        if user_input in gi.CHANGED.keys():
            user_input = gi.CHANGED[user_input]     # Changes the input into an acceptable format
...
def print_max_values(plateform,info,rank_list,sale_list,genre_list):
...
while True:
    ...
    if  user_platform == "0":
        ...
        if user_menu_option == "1":         # if the user chooses to find out about the max data
            print_max_values(user_platform, get_max(aquiring_data_to_useable_form(user_platform,rank,sale_number, genre)),rank,sale_number, genre) 
            ...
            print_min_values(user_platform, get_min(aquiring_data_to_useable_form(user_platform,rank,sale_number, genre)),rank,sale_number, genre)
            ...
            print_ave_values(user_platform, get_ave(aquiring_data_to_useable_form(user_platform,rank,sale_number, genre)),rank,sale_number, genre)
